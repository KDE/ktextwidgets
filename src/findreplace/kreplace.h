...
Q_SIGNALS:
     ...
     *
     * @deprecated since 5.81, use the KReplace::textReplaced(const QString &, int, int, int) signal instead
     */
    KTEXTWIDGETS_DEPRECATED_VERSION(5, 81, "Use the KReplace::textReplaced(const QString &, int, int, int) signal instead.")
